...
export default function BillingPage() {
  ...
  return (
    <div className="page">
      ...
      <p className="notice">
        Tenant: <strong>{brandId}</strong> · Currency:{" "}
      ...
      {state.status === "success" ? (
        <div className="success-card" role="status" aria-live="polite">
          ...
          <p className="success-card__detail">
            ...
            <code className="success-card__value">
              {state.result.invoiceId}
            </code>
          </p>
          <p className="success-card__detail">
            <span className="success-card__label">Amount</span>
            <strong className="success-card__value">
              {formatCurrency(state.result.amount, currency, locale)}
            </strong>
          </p>
        ...
        >
          <div className="field">
            ...
            <input
              ...
              aria-describedby={
                state.status === "error" ? "billing-error" : undefined
              }
